...
Route::middleware(['auth', 'role:Admin'])
    ...
    ->group(function () {
        ...
        Route::get('/attributes', [AdminDashboardController::class, 'attributeList'])->name('attributes.index');
        Route::get('/attributes/create', [AdminDashboardController::class, 'attributeCreate'])->name('attributes.create');
        Route::post('/attributes', [AdminDashboardController::class, 'attributeStore'])->name('attributes.store');
        Route::get('/attributes/{attribute}/edit', [AdminDashboardController::class, 'attributeEdit'])->name('attributes.edit');
        Route::put('/attributes/{attribute}', [AdminDashboardController::class, 'attributeUpdate'])->name('attributes.update');
        Route::delete('/attributes/{attribute}', [AdminDashboardController::class, 'attributeDestroy'])->name('attributes.destroy');

        // Stock Management
        Route::get('/stock/history', [AdminDashboardController::class, 'stockHistory'])->name('stock.history');
        Route::get('/stock/opname', [AdminDashboardController::class, 'stockOpname'])->name('stock.opname');
