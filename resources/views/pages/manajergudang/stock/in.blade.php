                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-lg shadow p-6 sticky top-24">
                        ...
                        <div x-show="selectedProductId" x-cloak class="space-y-4">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                {{-- [FIXED] Hapus referensi ke 'unit' --}}
                                <span class="text-lg font-bold text-gray-900 dark:text-white" x-text="currentStock"></span>
                            </div>
                            <div class="flex justify-between items-center text-sm">
                                <span class="text-gray-600 dark:text-gray-400">Jumlah Masuk:</span>
                                {{-- [FIXED] Hapus referensi ke 'unit' --}}
                                <span class="font-semibold text-green-500" x-text="`+ ${quantity || 0}`"></span>
                            </div>
                            <div class="border-t dark:border-slate-700 pt-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    {{-- [FIXED] Hapus referensi ke 'unit' --}}
                                    <span class="text-xl font-bold text-blue-600 dark:text-blue-400" x-text="finalStock"></span>
                                </div>
                            </div>
                            <div class="mt-8">
                                <button type="submit" class="w-full px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 shadow-md flex items-center justify-center">
