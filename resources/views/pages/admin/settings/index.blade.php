            ...
            <div class="space-y-6">
                ...
                <div class="pb-6 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="app_description" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                Deskripsi Aplikasi
                            </label>
                            <textarea
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white @error('app_description') border-red-500 @enderror"
                                id="app_description"
