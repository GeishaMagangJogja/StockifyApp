...
@section('content')
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Daftar Barang Keluar</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="w-full p-4 bg-white rounded-lg shadow-md dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-lg">
        {{-- Header Card --}}
        <div class="flex flex-col md:flex-row justify-between items-center mb-4 p-3 bg-gradient-to-r from-red-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 rounded-lg">
                ...
                <div class="md:col-span-2 lg:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="search" id="search"
                               ...
                               placeholder="Cari produk atau tujuan..."
                               value="{{ $search ?? '' }}">
                    </div>
                </div>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        <div class="w-8 h-8 bg-red-500 rounded-full flex items-center justify-center text-white font-bold mr-3 text-xs">
                                ...
                                {{-- Kolom Jumlah --}}
                                <td class="px-4 py-3">
                                    <span class="px-2 py-1 text-sm font-semibold text-red-700 bg-red-100 rounded-full dark:bg-red-900 dark:text-red-300">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <div class="max-w-xs">
                                        <p class="truncate">{{ $transaction->notes ?? '-' }}</p>
                                    </div>
                                </td>
